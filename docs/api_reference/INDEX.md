...
> **Canonical copy.** A near-duplicate older copy exists at [navigation/INDEX.md](navigation/INDEX.md) — prefer this file for lookups.
...
| [aoe4world-data-index.md](navigation/aoe4world-data-index.md) | Cross-reference guide for game data (units, buildings, technologies, civilizations in `game_data/extracted/aoe4/data/` folder) | Markdown | Navigate structured game balance data | Quick Ref |
...
→ Start: [aoe4world-data-index.md](navigation/aoe4world-data-index.md) | Then: navigate `game_data/extracted/aoe4/data/` subfolder

### "I need to understand game settings or mod loading"
→ Start: [systems/game-config-reference.md](systems/game-config-reference.md) | Raw data: `game_data/extracted/aoe4/sysconfig.lua`

### "I need raw engine API data (scardocs)"
→ Start: `game_data/extracted/aoe4/scardocs/README.md` | Parsed: `game_data/extracted/aoe4/scardocs/parsed_functions.json` | Enriched: [scar-engine-api-signatures.md](api/scar-engine-api-signatures.md)

---

## 🎯 Mod-Specific Resources

**Rule:** Always use the reference copy (`docs/gamemodes/MOD-INDEX.md`) for Copilot lookups. Never read `Scenarios/Japan/MOD-INDEX.md` directly (Scenarios Folder Scope restriction).
